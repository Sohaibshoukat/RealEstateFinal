  ...
  return (
    <>
      ...
      <div className="home-four ">
        ...
        <div className="container home_iconbox_container" style={{width:"95%"}}>
      ...
      <section className={style.About_Us}>
        <div className={`container ovh ${style.Content_about_response} `} style={{maxWidth:"90%"}}>
          ...
          <div className={style.About_main_Content}>
            <div className={style.Content_about}>
              <p>
                ...
                cum, magnam facere quia dolor alias minima eius illum nobis sunt
                tenetur eligendi!
              </p>
              <a href="" className="btn btn-thm">
                Discover know
              </a>
            </div>
          </div>
      ...
      <section className={style.Suggestion_Scroll}>
        <div className={`container ${style.scroller_data}`}  style={{maxWidth:"90%"}}>
          <div className={`row  ${style.First_scroller}`}>
            <div className="main-title text-left mb40">
      ...
      {/* <section id="best-property" className="best-property bgc-f7">
        <div className="container ovh"  style={{maxWidth:"90%"}}>
          <div className="row">
      ...
      <section id="property-city" className="property-city pb30">
        <div className="container"  style={{maxWidth:"90%"}}>
          <div className="row">
            <div className="col-lg-6">
              <div className="main-title text-left">
                <h1>Become a HomeOwner in just Seven Steps</h1>
              </div>
            </div>
          </div>
          <div className="row">
      ...
      <section
        id="property-city"
        className="property-city bgc-f7 pb30"
      >
        <div className="container" style={{maxWidth:"90%"}}>
          <div className="row">
            <div className="col-lg-6">
